...
public final class AsyncServerPipeline {
    ...
    public static class RequestContentStage {
         ...
         */
        public ResponseStage<String> asString() {
            return consume(r -> new BasicRequestConsumer<>(StringAsyncEntityConsumer::new));
        }

        /**
         * Configures the pipeline to process the incoming request content as a byte array.
         */
        public ResponseStage<byte[]> asByteArray() {
            return consume(r -> new BasicRequestConsumer<>(BasicAsyncEntityConsumer::new));
        }

        /**
         * Configures the pipeline to ignore and discard the incoming request content.
         */
        public ResponseStage<Void> ignoreContent() {
    ...
    public static class ResponseContentStage<I> {
         ...
         */
        public RequestHandlingStage<I, String> asString(final ContentType contentType) {
         ...
         */
        public RequestHandlingStage<I, byte[]> asByteArray(final ContentType contentType) {
