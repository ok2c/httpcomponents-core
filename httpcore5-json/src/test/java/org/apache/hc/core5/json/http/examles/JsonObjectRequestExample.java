 ...
 *
 */
package org.apache.hc.core5.json.http.examles;
...
import org.apache.hc.core5.json.http.AsyncJsonClientPipeline;
import org.apache.hc.core5.json.http.RequestData;
...
public class JsonObjectRequestExample {
    ...
    public static void main(final String... args) throws Exception {
        ...
        final AsyncJsonClientPipeline pipeline = new AsyncJsonClientPipeline(objectMapper);

        final Future<?> future = requester.execute(
                pipeline.post(uri).map(new BasicNameValuePair("name", "value")),
                pipeline.response().map(RequestData.class),
                Timeout.ofMinutes(1),
